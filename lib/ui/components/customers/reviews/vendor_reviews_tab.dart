  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: RefreshIndicator(
        onRefresh: () async {
          await ref.read(customerVmodel).vendorReviewProduct();
        },
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Builder(
                builder: (context) {
                  if (customerVm.busy(vendorReviewsState)) {
                    return SizerLoader(height: 600);
                  }
                  if (customerVm.error(vendorReviewsState)) {
                    return SizedBox(
                          ...
                          children: [
                            ProductColText(
                              ...
                              value: AppUtils.formatNumber(
                                  number:
                                      customerVm.vendorReviewsStats?.total ??
                                          0),
                            ),
                            Row(
                              children: [
                            ...
                            ProductColText(
                              ...
                              value: AppUtils.formatNumber(
                                  number:
                                      customerVm.vendorReviewsStats?.one ?? 0),
                              valueTextSize: Sizer.text(12),
                              valueColor: AppColors.green7,
                            ),
                          ],
