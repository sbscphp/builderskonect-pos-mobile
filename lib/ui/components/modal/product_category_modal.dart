...
class ProductCategoryModal extends ConsumerStatefulWidget {
  const ProductCategoryModal({super.key, this.isCategory = true});

  final bool isCategory;

  @override
  ConsumerState<ProductCategoryModal> createState() =>
      _ProductCategoryModalState();
}
